...
namespace TagerCom.Areas.Store.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet("pending")]
        public async Task<IActionResult> GetPending([FromQuery] FilterOrdersRequest request)
        {
            // Get user ======================================================================
            // ===============================================================================
            var user = await UserManager.GetUserAsync(User);
            ...
            // Get order =====================================================================
            // ===============================================================================
            var orders = await OrderRepo.GetAsync(e=>e.StoreId == store.Id && e.OrderStatus == OrderStatus.Pending, includes:[equals=>equals.Customer, ]);
            // ===============================================================================
